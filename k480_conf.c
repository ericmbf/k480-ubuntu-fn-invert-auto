...
#define HID_DEVICE_ID_K480                      (__s16)0xb33d
#define HID_DEVICE_ID_K480_ALT                  (__s16)0xb33d


const char k480_seq_fkeys_on[]  = {0x10, 0xff, 0x0b, 0x1e, 0x00, 0x00, 0x00};
const char k480_seq_fkeys_off[] = {0x10, 0xff, 0x0b, 0x1e, 0x01, 0x00, 0x00};
